...
import { ApinniPlugin, ShareableRegistry, ShareableContext } from 'apinni';
...
import { ShareablePlugin, ShareableRegistry, ShareableContext } from 'apinni';
...
<Tabs>
  <TabItem value="dependent-plugin" label="Dependent Plugin" default>
    ...
    import { ApinniPlugin, ShareableContext } from 'apinni';

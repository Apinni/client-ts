...
<Tabs groupId="config">
  ...
  <TabItem value="ts" label="Typescript">
    ...
    ```ts
    import type { ApinniConfig } from "apinni";
...
| **Endpoints missing or incorrect**         | Ensure you haven't used named imports (`import { ApinniController as Controller } from 'apinni'`) |
